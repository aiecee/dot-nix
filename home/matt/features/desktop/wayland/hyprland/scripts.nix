...
let
  ...
  bemenu-args = ''
    -W 0.3 -l 10 -B 2 -R 8 -n -c --fn "${family} 12" --bdr "#${palette.base0A}" --tb "#${palette.base00}" --fb "#${palette.base00}" --nb "#${palette.base00}" --hb "#${palette.base00}" --ab  "#${palette.base00}" --tf "#${palette.base0A}" --ff "#${palette.base05}" --nf "#${palette.base05}" --hf "#${palette.base0A}" --af "#${palette.base05}"
  '';
in
{
